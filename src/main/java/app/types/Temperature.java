...
public class Temperature extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }
   ...
   private String temp_last_changed_time;
   ...
   */
  public Temperature(String topic, String key, String currenttime, String temp_last_changed_time, String fahrenheit, String celcius, Integer partition, Integer offset) {
    this.topic = topic;
    this.key = key;
  ...
  public void put(int field$, Object value$) {
    switch (field$) {
    case 0: topic = (String)value$; break;
    case 1: key = (String)value$; break;
    case 2: currenttime = (String)value$; break;
    case 3: temp_last_changed_time = (String)value$; break;
    case 4: fahrenheit = (String)value$; break;
    case 5: celcius = (String)value$; break;
    case 6: partition = (Integer)value$; break;
    case 7: offset = (Integer)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public String getTempLastChangedTime() {
   ...
   * @param value the value to set.
   */
  public void setTempLastChangedTime(String value) {
   ...
   * @param value the value to set.
   */
  public void setCelcius(String value) {
    this.celcius = value;
  }
   ...
   * @return A new Temperature RecordBuilder
   */
  public static Builder newBuilder(Temperature other) {
    return new Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Temperature>
     ...
     * @param other The existing instance to copy.
     */
    private Builder(Temperature other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.topic)) {
        this.topic = data().deepCopy(fields()[0].schema(), other.topic);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setCurrenttime(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setTempLastChangedTime(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder clearTempLastChangedTime() {
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setFahrenheit(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder clearFahrenheit() {
      fahrenheit = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setCelcius(String value) {
    ...
    public Temperature build() {
      try {
        ...
        record.topic = fieldSetFlags()[0] ? this.topic : (String) defaultValue(fields()[0]);
        record.key = fieldSetFlags()[1] ? this.key : (String) defaultValue(fields()[1]);
        record.currenttime = fieldSetFlags()[2] ? this.currenttime : (String) defaultValue(fields()[2]);
        record.temp_last_changed_time = fieldSetFlags()[3] ? this.temp_last_changed_time : (String) defaultValue(fields()[3]);
        record.fahrenheit = fieldSetFlags()[4] ? this.fahrenheit : (String) defaultValue(fields()[4]);
        record.celcius = fieldSetFlags()[5] ? this.celcius : (String) defaultValue(fields()[5]);
        record.partition = fieldSetFlags()[6] ? this.partition : (Integer) defaultValue(fields()[6]);
        record.offset = fieldSetFlags()[7] ? this.offset : (Integer) defaultValue(fields()[7]);
        return record;
      } catch (Exception e) {
